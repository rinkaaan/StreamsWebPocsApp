...
export default function Tools() {
  return (
    ...
    >
      ...
      >
        Although StreamsWebPocs is mainly intended for use with spoken audio received through a microphone, you can also transcribe audio from your computer by enabling stereo mix for Windows computers or
